		  ...
		  <div className = 'aboutWrapper'>
		    ...
		    { !this.props.isAuthenticated && 
					<div className = 'description'>
						<p>You can go ahead and view <Link to = 'quiz'>existing quizzes</Link> or login to create your own quizzes. If you want your score to be recorded on the leaderboard, be sure to login before taking the quiz. Enjoy! <i className="em em-smile"></i></p>
					</div> }
