...
export default class Create extends React.Component {
	...
	onEditorStateChange:  Function = (editorState) => {
		 ...
		 this.setState({
			editorState,
			['questionTitle']: (draftToHtml(convertToRaw(this.state.editorState.getCurrentContent())))
		 })
	...
	handleEditQuizTitle() {
		...
		console.log('this.state.editQuizTitle🎅🎅🎅🎅🎅', this.state.editQuizTitle);
	}
	// changeQuestion
	...
	render() {
		console.log('this.state.quiz.quetions🎅🎅🎅🎅🎅', this.state.quiz.quetions);
		const {correctAnswer, answers, editorState} = this.state;
		...
		return (
			<div className='createComponent'>
				...
				<div>
					<h1>Create a Quiz</h1>
					<p className='subtitle'>You can create a new quiz here. Add as many questions as you want, you can always edit
						them later! However, after submission you cannot edit the quiz.</p>
				...
				<div>
							...
							return (
								<div key={idx}>
									...
									<div className='editButtonsWrapper'>
										<button onClick={this.addEditOption.bind(this, idx)} className='editBtn addOptionEdit'>Add Another
											Option
										</button>
										<button onClick={this.submitQuestionEdit.bind(this, idx)} className='editBtn submitEdit'>Submit
											Edit
										</button>
									</div>
								</div>
					...
					<h2 className='errorMsg'>You have to enter some questions to submit a new quiz!</h2>}
